...
const EditModelPopup = ({ isOpen, onClose, model, onSave }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ submit: error.message || t('config.update_model_failed') });
    } finally {
      setIsSubmitting(false);
    }
  };
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-container edit-model-modal" onClick={e => e.stopPropagation()}>
        <div className="modal-header">
          <h3>{t('config.edit_model_title')}</h3>
        ...
        <form onSubmit={handleSubmit} className="edit-model-form">
          ...
          <div className="form-item">
            ...
            <span className="form-hint">{t('config.model_id_readonly_hint')}</span>
          </div>
          ...
          <div className="form-actions">
            ...
            <button 
              ...
              disabled={isSubmitting}
            >
              {isSubmitting ? t('status.saving') : t('config.save_changes')}
            </button>
          </div>
        </form>
      </div>
